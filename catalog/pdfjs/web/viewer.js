...
function confirmExit() {
  ...
  $.ajax({
    method: 'POST',
    url: 'savePageNumber.php',
    data: {page: currentPage},
    asynch: false,
    timeout: 2000,
    error: function(){
      return "We couldn't save the page number. Please try closing the tab again";
    },
    success: function(){ 
      return null;              // evita l'apertura della finestra di conferma della chiusura
    }
  });
}
